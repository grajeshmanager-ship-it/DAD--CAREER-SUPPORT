                  ...
                  {matches.map((match, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ fontSize: "11px", color: "rgba(235,229,220,0.25)", fontFamily: sans }}>{match.experience_years}y experience · {match.location_country || "Location private"}</div>
                      </div>
                    );
                  })}
                    ...
                    <div style={{ background: dark, padding: "28px", borderLeft: "0.5px solid rgba(201,168,76,0.08)" }}>
                      ...
                      <div style={{ marginBottom: "20px" }}>
                        ...
                        {selectedMatch.reasons.map((r, i) => (
                          <div key={i} style={{ fontSize: "12px", color: "rgba(235,229,220,0.45)", fontFamily: sans, marginBottom: "6px", display: "flex", gap: "8px", lineHeight: "1.5" }}>
                      ...
                      {selectedMatch.target_roles?.length > 0 && (
                        <div style={{ marginBottom: "20px" }}>
                          <div style={{ fontSize: "10px", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(201,168,76,0.4)", marginBottom: "8px", fontFamily: sans }}>Target roles</div>
                          <div style={{ fontSize: "12px", color: "rgba(235,229,220,0.4)", fontFamily: sans }}>{selectedMatch.target_roles.join(" · ")}</div>
                        </div>
                      )}
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px", padding: "12px 0", borderTop: "0.5px solid rgba(235,229,220,0.04)" }}>
                        ...
                        <div style={{ fontSize: "24px", fontWeight: "200", color: stageColor }}>{selectedMatch.score}% match</div>
                      </div>
                      <button onClick={() => sendConnection(selectedMatch.id)} disabled={connecting === selectedMatch.id}
                        ...
                        {connecting === selectedMatch.id ? "Sending request..." : "Connect →"}
                      </button>
                      <p style={{ fontSize: "10px", color: "rgba(235,229,220,0.15)", fontFamily: sans, textAlign: "center", marginTop: "10px", lineHeight: "1.6" }}>
                        They will see your skills and stage. Names revealed only when both accept.
                      </p>
                    </div>
                  );
                })()}
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: "10px", color: stageColor, fontFamily: sans }}>{STAGE_LABELS[otherProfile?.career_stage] || "Unknown stage"}</div>
                        ...
                        <div style={{ fontSize: "20px", fontWeight: "200", color: stageColor, flexShrink: 0 }}>{conn.match_score}%</div>
                      </div>
                    </div>
                  );
                })
