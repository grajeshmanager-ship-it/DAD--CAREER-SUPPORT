        ...
        <div className="mb-10">
          ...
          {companionName ? (
            <p className="text-muted-foreground text-lg">
              {companionEmoji} {companionName} is here and ready to help. What do you want to work on today?
            </p>
          ) : (
            <p className="text-muted-foreground text-lg">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-10">
          ...
          <Link href="/career">
            <Card className="p-6 border border-border hover:border-primary/50 transition-all duration-200 cursor-pointer group bg-card/50 hover:bg-card h-full">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Fresh graduate or no experience? Answer a few questions and get a personalised career roadmap, skill plan and job matches
              </p>
              <div className="flex items-center text-primary text-sm font-medium">
