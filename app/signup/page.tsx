    ...
    return (
      <div style={{ minHeight: "100vh", background: bg, color: text, fontFamily: serif, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "480px", width: "100%" }}>
          ...
          <input type="text" placeholder={companion?.sub} value={companionName} onChange={e => setCompanionName(e.target.value)} autoFocus onKeyDown={e => e.key === "Enter" && setStep("account")} style={{ width: "100%", background: "transparent", border: "none", borderBottom: `1px solid ${companion?.color}40`, color: text, fontSize: "clamp(28px, 4vw, 48px)", fontFamily: serif, fontWeight: "300", textAlign: "center", padding: "12px 0", outline: "none", marginBottom: "48px", letterSpacing: "0.04em" }} />
      ...
      <div style={{ minHeight: "100vh", background: bg, color: text, fontFamily: serif, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px" }}>
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "420px", width: "100%" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", marginBottom: "32px", textAlign: "left" }}>
            {[
              ...
              <div key={i} style={{ borderBottom: "0.5px solid rgba(201,168,76,0.12)", paddingBottom: "4px", marginBottom: "28px" }}>
                ...
                <input type={field.type} placeholder={field.placeholder} value={field.value} onChange={e => field.setter(e.target.value)} style={{ width: "100%", background: "transparent", border: "none", color: text, fontSize: "16px", fontFamily: sans, fontWeight: "300", padding: "4px 0", outline: "none" }} />
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "flex", gap: "16px", justifyContent: "center" }}>
            ...
            <button onClick={handleSignup} disabled={loading} style={{ background: loading ? "rgba(201,168,76,0.5)" : companion?.color, color: bg, border: "none", padding: "14px 40px", cursor: loading ? "not-allowed" : "pointer", fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase", fontFamily: sans, transition: "background 0.3s" }}>
